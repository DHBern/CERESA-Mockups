...
<div class="grid grid-cols-2">
	...
	<div class="p-15">
		...
		<p>
			...
			tradotta. Nata nello stato della Georgia nel 1917, tra i venti e i ventisette anni ha scritto
			tre romanzi clamorosi: The Heart is a lonely Hunter, Reflections in a Golden Eye e The Member
			of the Wedding. Tutti e tre sono stati pubblicati in traduzione francese da Stock – l’ultimo,
			sotto il titolo Frankie Addams, solo di recente – e hanno riscosso, si può dire in tutta
			sincerità, un’accoglienza entusiastica in Francia. Questo nonostante la giovane autrice non si
			presti alle discussioni, così popolari in Francia, sulla problematica della letteratura
			romanzesca americana ed europea (ovvero le “recherches romanesques”). Dal punto di vista
			biografico, non sappiamo molto di Carson McCullers; rare fotografie ci mostrano il volto
			pallido, molto tragico e allo stesso tempo quasi infantile di questa scrittrice di grande
			talento, che già nel suo primo libro ha dimostrato una padronanza magistrale dello stile e
			dell’espressione, e dei cui libri si dice che siano crudeli e degni di Faulkner. Senza cadere
			in tale “liquidazione” un po’ semplicistica della particolarità di Carson McCullers, non si
		...
		<p>
			Reflections in a Golden Eye sembra essere un’opera molto più “letteraria”; la storia è
			raccontata in modo volutamente artificiale. I personaggi, trattati come semplici comparse in
			una vera e propria “illuminazione psicoanalitica”, vengono condotti con polso fermo al
			risultato di per sé banale di un omicidio. Ciò nonostante, proprio questo libro “sofisticato”
			racchiude e comprende nei suoi tratti essenziali tutta la potenza dell’arte narrativa di
			Carson McCullers. Riassuntivo e rivelatore non solo dei mezzi e dei fini della sua autrice, ma
			anche e soprattutto di un’epoca e delle sue principali realtà morali e psicologiche. Di The
			Member of the Wedding è stato recentemente rappresentato a Manhattan un adattamento teatrale
			scritto dall’autrice stessa. Si tratta degli anni dell’adolescenza, ingenui, sciocchi e
			tristi. Con quanta cura, con quanto amore Carson McCullers descrive il mondo e l’indole di
			Frankie Jasmine Addams, questa ragazza dodicenne troppo alta, i cui desideri sono tanto più
			intensi quanto più vagano inutili e insensati in fantasie e impossibilità.
		</p>
		<p>
			In effetti, se Carson McCullers, i suoi libri e il suo modo di concepire la scrittura e la
			vita rappresentano la “giovane America”, allora questa giovane America ci commuove più
